...
export type VideostateActionMutation = { __typename?: 'Mutation', Videostate_postById?: { __typename?: 'Videostate', video_id: string, state: string, download_url: string } | null };
...
export type VideostateQuery = { __typename?: 'Query', Videostate_getById: { __typename?: 'Videostate', video_id: string, state: string, download_url: string } };
